...
var CNATIVE = /*#__PURE__*/function (_NativeCurrency) {
  ...
  function CNATIVE(chainId) {
    var symbol = [137, 43114].includes(chainId) ? 'AVAX' : [56, 97].includes(chainId) ? 'BNB' : 'ETH';
    var name = [137, 43114].includes(chainId) ? 'Avalanche' : [56, 97].includes(chainId) ? 'BNB' : 'Ethereum';
